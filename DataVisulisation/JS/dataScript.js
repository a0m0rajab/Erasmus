...
let seprator = ",";
let exampleFiles = ["examples/chartData.csv", "examples/GraphLine.csv", "examples/BubbleChart.csv"];
            ...
            buttons: [
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        let z = getElementsOfRow(dt, 2, 1);
                        let a = getElementsOfRow(dt, 3);
                        let b = getElementsOfRow(dt, 4, 1);

                        drawLineGraph(x, y, z, a, b);
